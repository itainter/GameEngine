...
namespace Engine
{
    class SystemLog : public ILog, public ECSSystemBase<>
    {
    public:
        SystemLog() {}
        virtual ~SystemLog() {}
    ...
    template<>
    inline void SystemLog::OutputLogInputStream<eEv_Input_KeyChar>(LogInputKeyCharPtr data) const
    {
    ...
    template<>
    inline void SystemLog::OutputLogInputStream<eEv_Input_KeyDown>(LogInputKeyDownPtr data) const
    {
    };

    template<>
    inline void SystemLog::OutputLogInputStream<eEv_Input_KeyUp>(LogInputKeyUpPtr data) const
    {
    };
}