...
BasicPrimitive_VertexAttr BasicPrimitive_VS(BasicPrimitive_Input input)
{
    ...
    float4x4 viewMatrix = LookAt(float3(3.0f, 3.0f, -3.0f), float3(0.0f, 0.0f, 0.0f), float3(0.0f, 0.0f, -1.0f));
    float4x4 projectionMatrix = Projection(90.0f, 1080.0f / 1080.0f, 1.0f, 100.0f);
